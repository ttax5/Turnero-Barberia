/* ================================================================
   ...
   Responsabilidad: Estado global, DOMContentLoaded, fetch inicial
   ================================================================ */
...
/* Carga datos persistidos de localStorage si existen */
function cargarDesdeLocalStorage() {
  const turnosGuardados = localStorage.getItem(CLAVE_TURNOS);
  if (turnosGuardados) estado.turnos = JSON.parse(turnosGuardados);

  const barberosGuardados = localStorage.getItem(CLAVE_BARBEROS);
  if (barberosGuardados) estado.barberos = JSON.parse(barberosGuardados);
}
